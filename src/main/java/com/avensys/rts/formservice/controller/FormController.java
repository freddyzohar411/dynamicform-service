...
/***
 * @author Koh He Xiang This class is used to handle the API calls for the
 *         account service.
 */
...
public class FormController {
	...
	public ResponseEntity<Object> getForm(@PathVariable int formId) {
		...
		return ResponseUtil.generateSuccessResponse(formResponseDTO, HttpStatus.OK,
	...
	public ResponseEntity<Object> getAllForms() {
		log.info("Form get: Controller");
		return ResponseUtil.generateSuccessResponse(formService.getAllForms(), HttpStatus.OK,
				messageSource.getMessage(MessageConstants.MESSAGE_SUCCESS, null, LocaleContextHolder.getLocale()));
	}
	...
	public ResponseEntity<Object> getBaseForms() {
		log.info("Form get: Controller");
		return ResponseUtil.generateSuccessResponse(formService.getBaseForms(), HttpStatus.OK,
				messageSource.getMessage(MessageConstants.MESSAGE_SUCCESS, null, LocaleContextHolder.getLocale()));
	}
	...
	public ResponseEntity<Object> getFormListing(@RequestBody FormListingRequestDTO formListingRequestDTO) {
		...
		if (searchTerm == null || searchTerm.isEmpty()) {
			...
			return ResponseUtil.generateSuccessResponse(
					formService.getFormListingPage(page, pageSize, sortBy, sortDirection), HttpStatus.OK,
					messageSource.getMessage(MessageConstants.MESSAGE_SUCCESS, null, LocaleContextHolder.getLocale()));
		}
		return ResponseUtil.generateSuccessResponse(
				formService.getFormListingPageWithSearch(page, pageSize, sortBy, sortDirection, searchTerm),
				HttpStatus.OK,
				messageSource.getMessage(MessageConstants.MESSAGE_SUCCESS, null, LocaleContextHolder.getLocale()));
	}
	...
	public ResponseEntity<Object> getFormCategories() {
		...
		return ResponseUtil.generateSuccessResponse(formCategories, HttpStatus.OK,
				messageSource.getMessage(MessageConstants.MESSAGE_SUCCESS, null, LocaleContextHolder.getLocale()));
	}
	...
	public ResponseEntity<Object> getFormByCategory(@PathVariable String formCategory) {
		...
		log.info("Form get: Controller");
		FormTemplateNamesListResponseDTO formResponseDTOList = formService
				.getFormsTemplateNamesByCategory(formCategory);
		return ResponseUtil.generateSuccessResponse(formResponseDTOList, HttpStatus.OK,
				messageSource.getMessage(MessageConstants.MESSAGE_SUCCESS, null, LocaleContextHolder.getLocale()));
	}

	@PostMapping("/formname/idmap")
	public ResponseEntity<Object> getFormTemplateNamesIdMap(@RequestBody List<String> formTemplateNames) {
		log.info("Form get form names to id: Controller");
		return ResponseUtil.generateSuccessResponse(formService.getFormTemplateNamesIdMap(formTemplateNames),
				HttpStatus.OK,
				messageSource.getMessage(MessageConstants.MESSAGE_SUCCESS, null, LocaleContextHolder.getLocale()));
	}
